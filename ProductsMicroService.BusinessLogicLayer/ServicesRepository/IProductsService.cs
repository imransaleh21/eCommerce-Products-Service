...
public interface IProductsService
{
    ...
    Task<List<ProductResponse>?> GetProductsByCondition(Expression<Func<ProductResponse, bool>> predicate);
    /// <summary>
    ...
    Task<ProductResponse?> GetProductByCondition(Expression<Func<ProductResponse, bool>> predicate);
    /// <summary>
